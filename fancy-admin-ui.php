...
function fau_login_theme_style() {
  ...
  wp_enqueue_style(
    'fau-login-style',
    FANCY_ADMIN_URL. 'css/fau_styles_login.css'
	);
...
function fau_admin_bar_theme_style() {
  ...
  wp_enqueue_style(
		'fau-admin-bar-style',
		FANCY_ADMIN_URL. 'css/fau_styles_adminbar.css'
	);

  if (file_exists(FANCY_ADMIN_ROOT. 'css/estilos_custom_lojica.css')) {
    wp_enqueue_style(
      'admin_bar_custom_lojica',
      FANCY_ADMIN_URL. 'css/estilos_custom_lojica.css'
    );
  }
...
add_action('init',function(){
  if(current_user_can('edit_posts'))
    add_action( 'wp_enqueue_scripts', 'fau_admin_bar_theme_style' );
});
...
function fau_admin_theme_style() {
  ...
  wp_enqueue_style(
		'fau-admin-style',
		FANCY_ADMIN_URL. 'css/fau_styles_admin.css'
	);
...
add_action('init',function(){
  if(current_user_can('edit_posts'))
    add_action( 'wp_enqueue_scripts', 'fau_admin_theme_style' );
});
